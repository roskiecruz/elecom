			...
			<div class="container">
				...
				<div class="nav-collapse collapse">
					<ul class="nav pull-right">
						<li class="active"><a href="studentHomeScroll.php"><i class="icon-home"></i> Home</a></li>
		...
		<div class="row-fluid">
			...
			<div class="span4">
				...
				<ul class="nav nav-list" data-spy="affix" data-offset-top="570">
					...
					<li class="divider"></li>
					<center><a href="studentVote.html" class="btn btn-success btn-large">Start voting!</a></center>
				</ul>
				</section>
			</div>
